...
USERNAME = 'student'  # Change this to your student username
PASSWORD = 'student' # Change this to your student password
...
data = {
    ...
    'gps_long':  78.4368,
    'student': 4 # Just passing ID (though backend uses logged-in user)
}
